...
| File                              | Purpose                        |
|-----------------------------------|--------------------------------|
| `refactor/runner_v2.py`          | CLI entry point                |
| `refactor/pipeline_v2.py`        | Orchestrator — runs all steps  |
| `refactor/strategy/breadth_v2.py`| Market breadth computation     |
| `refactor/strategy/rs_v2.py`     | Relative strength z-scores     |
| `refactor/strategy/rotation_v2.py`| Sector rotation regimes       |
| `refactor/strategy/scoring_v2.py`| Composite score calculation    |
| `refactor/strategy/signals_v2.py`| Signal generation & convergence|
| `refactor/strategy/portfolio_v2.py`| Portfolio construction        |
| `refactor/report_v2.py`          | Text report builder            |
