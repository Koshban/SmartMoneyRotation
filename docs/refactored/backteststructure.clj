...
# Example: India-specific tuning
ACTIONPARAMS_V2["buy"]["min_percentile"] = 0.50
ACTIONPARAMS_V2["buy"]["min_score"] = 0.55
ACTIONPARAMS_V2["decent_momentum"]["min_rsi"] = 40
ACTIONPARAMS_V2["decent_momentum"]["min_adx"] = 14
ACTIONPARAMS_V2["weak_context"]["sector_regimes"] = []  # stop killing lagging sectors