...
| Config | `common/config.py` | `refactor/common/config_refactor.py` |
| Signal generation | `strategy/signals.py` | `refactor/strategy/signals_v2.py` |
| Convergence | `strategy/convergence.py` | `refactor/strategy/` (partially broken) |
